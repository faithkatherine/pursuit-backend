...
class Command(BaseCommand):
    ...
    def load_categories(self):
        ...
        categories_data = [
            {"name": "Travel", "icon": "✈️", "description": "Travel destinations and experiences", "color": "#FF6B6B"},
            {
                "name": "Adventure",
                "icon": "🏔️",
                "description": "Outdoor adventures and extreme activities",
                "color": "#4ECDC4",
            },
            {
                "name": "Food & Drink",
            ...
            },
            {
                "name": "Culture",
                "icon": "🎭",
                "description": "Cultural events and artistic experiences",
                "color": "#96CEB4",
            },
            {
                "name": "Learning",
                "icon": "📚",
                "description": "Educational experiences and skill building",
                "color": "#FECA57",
            },
            {"name": "Sports", "icon": "⚽", "description": "Sports activities and events", "color": "#FF9FF3"},
            {
                "name": "Music & Events",
                "icon": "🎵",
