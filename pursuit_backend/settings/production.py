...
if SECRET_KEY == "django-insecure-change-me-in-production":  # noqa: F405
    _errors.append("SECRET_KEY is still the insecure default. " "Set a strong SECRET_KEY env var for production.")
...
if not ALLOWED_HOSTS:
    _errors.append("ALLOWED_HOSTS must be set in production (comma-separated).")
...
if not _db_url and os.environ.get("DB_PASSWORD", "pursuit_password") == "pursuit_password":
    _errors.append("DB_PASSWORD is still the insecure default. " "Set a strong DB_PASSWORD env var for production.")
